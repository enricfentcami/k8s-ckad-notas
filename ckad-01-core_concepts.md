...
Yo can override `command` and/or `args`.

Another format of command and args:
```yaml
apiVersion: v1
kind: Pod
metadata:
...
This topic will be completed in the [Network Services](ckad-06-services_network-01-services.md) section.
